    ...
    describe('when DATABASE_TYPE is mysql', () => {
      ...
      describe('DATABASE_HOST', () => {
        it('should fail when empty', () => {
          ...
          expect(result).toThrow(
            new EnvironmentConfigError(
              'Config validation error: "DATABASE_HOST" is not allowed to be empty',
            ),
          );
        });
      });
      ...
      describe('DATABASE_PORT', () => {
        it('should fail when not a number', () => {
          ...
          expect(result).toThrow(
            new EnvironmentConfigError(
              'Config validation error: "DATABASE_PORT" must be a number',
            ),
          );
        });
      });
      ...
      describe('DATABASE_USERNAME', () => {
        it('should fail when empty', () => {
          ...
          expect(result).toThrow(
            new EnvironmentConfigError(
              'Config validation error: "DATABASE_USERNAME" is not allowed to be empty',
            ),
          );
        });
      });
      ...
      describe('DATABASE_PASSWORD', () => {
        it('should fail when empty', () => {
          ...
          expect(result).toThrow(
            new EnvironmentConfigError(
              'Config validation error: "DATABASE_PASSWORD" is not allowed to be empty',
            ),
          );
        });
      });
